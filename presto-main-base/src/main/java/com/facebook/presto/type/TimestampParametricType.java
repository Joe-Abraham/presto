        ...
        implements ParametricType
{
    ...
    public Type createType(List<TypeParameter> parameters)
    {
        if (parameters.isEmpty()) {
            return TimestampType.createTimestampType(TimestampType.DEFAULT_PRECISION);
        }
        ...
        if (precision < 0) {
            throw new IllegalArgumentException("Invalid TIMESTAMP precision: " + precision + ". Precision must be non-negative.");
        }
