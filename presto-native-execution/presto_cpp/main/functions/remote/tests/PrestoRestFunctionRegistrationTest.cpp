...
class PrestoRestFunctionRegistrationTest : public ::testing::Test {
 protected:
  ...
  std::string getRemoteFunctionServerUrl(
    ...
    return instance.getRemoteFunctionServerUrl(restFunctionHandle);
  }
};
...
TEST_F(
  ...
  std::string httpResult = getRemoteFunctionServerUrl(*httpHandle);
  std::string httpsResult = getRemoteFunctionServerUrl(*httpsHandle);
...
TEST_F(
  ...
  std::string result = getRemoteFunctionServerUrl(*handle);
