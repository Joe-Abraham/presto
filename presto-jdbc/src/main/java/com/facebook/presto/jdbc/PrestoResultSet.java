        ...
        implements ResultSet
{
            ...
            throws SQLException
    {
        ...
        ColumnInfo columnInfo = columnInfo(columnIndex);
        String rawType = columnInfo.getColumnTypeSignature().getBase();
        if (rawType.equalsIgnoreCase("timestamp") || rawType.equalsIgnoreCase("timestamp microseconds")) {
            try {
        ...
        if (rawType.equalsIgnoreCase("timestamp with time zone")) {
            try {
    ...
    {
        checkArgument(fromPrecision <= toPrecision, "fromPrecision must be <= toPrecision");
